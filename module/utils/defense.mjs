(async () => {
  ...
  let criticalSuccessThreshold = defense.criticalSuccessThreshold + (weapon.system.critDefense);
  ...
  const rollData = {
    ...
    per: actor.system.attributes.per.value,
     ...
     // DEFENSE ROLL
  const defenseRollFormula = `@combatSkills.meleeDefense.rating + @weaponDefense - 1d100`;
